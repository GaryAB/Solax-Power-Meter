...
inverterAddress = 'dhcp'          #address of inverter - use '5.8.8.8' if logged into inverter's access point
                                  #or 192.168.10.10 if you have the later WiFi module.
                                  #if logging into your house WiFi and the address is not static,  enter 'dhcp'
                                  #Set DCHP range of your router on the lines below
From = '192.168.1.1'              #Start of address range for DHCP allocation
To = '192.168.1.254'              #End of address range for DHCP allocation
...
# The following settings are for Octopus users only
...
# The following settings only apply if you have an electric car
# Please read the details on EV mode in the manual
...
# *These settings may be changed in the control panel

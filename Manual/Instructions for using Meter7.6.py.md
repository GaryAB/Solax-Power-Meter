###Instructions for using Meter7.6.py
...
If you want to use this function change the word 'MANUAL' to 'AUTO'. Meter7.6 will then automatically set the preload value and tell you what value it has set.

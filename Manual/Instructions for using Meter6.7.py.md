...
Also due to the discontinuous nature of the monitoring of the inverter by the SolaX Cloud, the values for Solar Yield and Battery Use should be considered as estimates.

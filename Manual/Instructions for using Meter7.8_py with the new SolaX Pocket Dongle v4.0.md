...
Go to your inverter and press the control button once on your WiFi dongle. This will start the dongle's access point (AP). This will only remain active for a few minutes before turning off again. While the AP is running, reboot your Raspberry Pi, and the Pi should connect to the dongle's AP.

###Instructions for use of the Solcast module
...
Each evening at 9 pm local time, the script will obtain the latest forecast from Solcast and calculate the recommended preload for the batteries for that night.

![](/Pictures/Preload.jpg)

The script will continue to display the result until 1 a.m., allowing plenty of time to change the setting on the inverter. 
...
The calculation also uses an estimate of your likely use of power during the next day. The estimate is based on previous use for that day of the week. 
...
I take no responsibility for the accuracy or otherwise of Solcast's predictions.
